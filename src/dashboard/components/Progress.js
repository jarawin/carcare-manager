...
import mockUpOrders from "../../data/mockUpOrders";
// import orders from "../../data/mockUpOrders";
...
function Progress() {
    ...
    React.useEffect(() => {
        dispatch(addOrder(mockUpOrders));
    }, []);
                    ...
                    <div className=" shadow-lg rounded-2xl p-4 bg-white dark:bg-gray-700 w-full">
                        <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center">
                                ...
                                <button
                                    ...
                                    onClick={() => dispatch(setShowSetting({ oIdx, isShow: true }))}
                                    onBlur={() => setTimeout(() => { dispatch(setShowSetting({ oIdx, isShow: false })) }, 100)}
                                >
                            ...
                            <div className="flex items-center">
                                <span className=" flex items-center font-semibold text-xs ">
                                    ...
                                    {item?.isMakeCommission ? (
                                        ...
                                        <a href={"/profile?id=" + item.customer_id} className="z-20">
                                            <img
                                                className="  w-10 h-10 rounded-full border-2 border-white dark:border-gray-800"
                                                src={item.customer_img}
                                                alt=""
                            ...
                            {item.services.map((service, sIdx) => {
                                return (
                                    ...
                                    >
                                        ...
                                        <div
                                            onClick={() => dispatch(setServiceDone({ sIdx, oIdx, isDone: !service.is_done }))}
                                        >
                        ...
                        <div className="flex items-center justify-start my-4 space-x-4">
                            {item.booking_time ? (
                                item.showBooking ? (
                                    <span
                                        onClick={() => dispatch(setShowBooking({ oIdx, isShow: false }))}
                                        className="px-2 py-1 flex items-center cursor-pointer text-xs rounded-md font-semibold text-blue-500 bg-blue-50"
                                    >
                                        {item.booking_time}
                                    </span>
                                ) : (
                                    <span
                                        onClick={() => dispatch(setShowBooking({ oIdx, isShow: true }))}
                                        className="px-2 py-1 flex items-center cursor-pointer font-semibold text-xs rounded-md text-blue-400 border border-blue-400  bg-white"
                                    >
                                        จองคิว
                                    </span>
                                )
                            ...
                            {item.arrived_time ? (
                                item.showArrived ? (
                                    <span
                                        onClick={() => dispatch(setShowArrived({ oIdx, isShow: false }))}
                                    ...
                                    <span
                                        onClick={() => dispatch(setShowArrived({ oIdx, isShow: true }))}
                            ...
                            {item.code ? (
                                item.showCode ? (
                                    <span
                                        onClick={() => dispatch(setShowCode({ oIdx, isShow: false }))}
                                    ...
                                    <span
                                        onClick={() => dispatch(setShowCode({ oIdx, isShow: true }))}
                        ...
                        <div className="flex items-left justify-left mb-2 space-x-2 overflow-hidden items-center justify-between">
                            <span
                                ...
                                onClick={e => dispatch(prevStatus({ oIdx, status: item.order_status }))}
                            >
                                <IoIosArrowBack /> Prev
                            </span>
                            <span
                            ...
                            <span
                                className="px-2 py-1 flex items-center font-semibold text-xs rounded-md text-gray-500 bg-gray-200 cursor-pointer hover:bg-gray-400 hover:text-white"
                                onClick={e => dispatch(nextStatus({ oIdx, status: item.order_status }))}
                            >
